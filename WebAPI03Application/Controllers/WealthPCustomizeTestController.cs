...
namespace WebAPI03Application.Controllers
{
    ...
    [RoutePrefix("api/WealthPCustomizeTest")]

    public class WealthPCustomizeTestController : ApiController
    {
        /*
        ...
        */
        ...
        {
            WealthPCustomizePersistanceTest wpc = new WealthPCustomizePersistanceTest();
            if (wpc == null)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.NotFound));
            }
